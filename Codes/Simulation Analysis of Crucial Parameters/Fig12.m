%% The Impact of M Changes on the Evolution Path
clc,clear;
figure('color',[1 1 1]);
Q=50,p=5,w=3,r=0.1,I1=30,I2=50,S1=15,S2=25,K1=30,K2=45,C=30,T1=10,T2=20,T3=10,L=20,M=5,H1=20,H2=20;
[t,y]=ode45(@(t,y) CGB(t,y,Q,p,w,r,I1,I2,S1,S2,K1,K2,C,L,T1,T2,T3,M,H1,H2),[0 50],[0.3 0.3 0.3]);
stem3(y(:,1),y(:,2),y(:,3),'r+','linewidth',1);
hold on;
Q=50,p=5,w=3,r=0.1,I1=30,I2=50,S1=15,S2=25,K1=30,K2=45,C=30,T1=10,T2=20,T3=10,L=20,M=10,H1=20,H2=20;
[t,y]=ode45(@(t,y) CGB(t,y,Q,p,w,r,I1,I2,S1,S2,K1,K2,C,L,T1,T2,T3,M,H1,H2),[0 50],[0.3 0.3 0.3]);
...
hold on;   
Q=50,p=5,w=3,r=0.1,I1=30,I2=50,S1=15,S2=25,K1=30,K2=45,C=30,T1=10,T2=20,T3=10,L=20,M=20,H1=20,H2=20;
[t,y]=ode45(@(t,y) CGB(t,y,Q,p,w,r,I1,I2,S1,S2,K1,K2,C,L,T1,T2,T3,M,H1,H2),[0 50],[0.3 0.3 0.3]);
...
legend({'{\it\fontname{Bodoni MT}M}=5','{\it\fontname{Bodoni MT}M}=10','{\it\fontname{Bodoni MT}M}=15','{\it\fontname{Bodoni MT}M}=20'},'location','northeast');
